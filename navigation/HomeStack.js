...
const HomeProdStack = () => {
  return (
    ...
    <Stack.Navigator  screenOptions={{...headerstyle,headerTintColor: 'white',}} >
          ...
          <Stack.Screen name="HomeScreen" component={HomeScreen} options={{...headerstyle, headerTintColor: 'white',title : 'Products' }} />
        </Stack.Navigator>
  )
}
      ...
      <Tab.Navigator 
        screenOptions={({ route }) => ({
          tabBarIcon: ({ focused, color, size }) => {
            ...
            iconColor = focused ? '#151542' : 'black';
    ...
    <Stack.Navigator screenOptions={{
      ...
      <Stack.Group >
        ...
        <Stack.Group >
          ...
          <Stack.Screen name="EditProductScreen" component={EditProductScreen} options={{...headerstyle, headerTintColor: 'white' }} />
        </Stack.Group>
      </Stack.Group>

      {/* ORDERS GROUP */}
      <Stack.Group screenOptions={{...headerstyle,headerTintColor: 'white'}} >
