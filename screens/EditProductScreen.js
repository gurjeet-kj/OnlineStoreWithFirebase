...
import { createProduct,updateProduct,getAllCategories,getProduct,removeProduct } from '../components/FirebaseOperations';
...
const EditProductScreen = ({navigation,route}) => {
    ...
    const renderCategoryList = () => {
        return categories.map((cat,i) => {
          ...
          style={[{
            backgroundColor : productCategory == cat.id ? '#393b9b' : 'white',
