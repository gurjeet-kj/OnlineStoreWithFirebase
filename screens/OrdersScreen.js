...
import { getUserOrders,getAsyncUser, getAllOrders } from '../components/FirebaseOperations';
        ...
        return (
          <View style={{ height: '100%', alignItems: 'center', justifyContent: 'center' }}>
            <Menu
              ...
              style={{width: 200}}
            >
              <MenuItem style={[{backgroundColor : filterOrders === 'all' ? '#393b9b' : 'white'}]} 
              textStyle={[{color : filterOrders === 'all' ? 'white' : 'black'}]} onPress={ () => {updateOrders('all');filterOrdersSet('all'); hideMenu();}}>All</MenuItem>
              <MenuItem style={[{backgroundColor : filterOrders === 'pending' ? '#393b9b' : 'white'}]}
              ...
              <MenuItem style={[{backgroundColor : filterOrders === 'ready-for-shipment' ? '#393b9b' : 'white'}]} 
              ...
              <MenuItem style={[{backgroundColor : filterOrders === 'shipped' ? '#393b9b' : 'white'}]} 
              ...
              <MenuItem style={[{backgroundColor : filterOrders === 'completed' ? '#393b9b' : 'white'}]} 
              ...
              <MenuItem style={[{backgroundColor : filterOrders === 'canceled' ? '#393b9b' : 'white'}]} 
