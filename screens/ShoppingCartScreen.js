...
import { updateOrderState,removeItemShoppingCart,getShopListDoc,getAsyncUser } from '../components/FirebaseOperations';
                        ...
                        return (
                            <View style={styles.listItem}>
                                ...
                                <TouchableOpacity style={{width:'10%'}} onPress={() => {removeItem(index)}}>
                                    <Text><Ionicons name='close' size={30} color={'#FF4E4E'} /></Text>
                                </TouchableOpacity> 
                            </View> 
                        )}}
