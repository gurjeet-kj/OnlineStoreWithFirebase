...
import { createCategory,updateCategory,getAllCategories,removeCategory,removeProductByCategory } from '../components/FirebaseOperations';
        ...
        <View style ={styles.container}>
          ...
          <FlatList
            ...
            renderItem={({cat,item,index}) => {
                return (
                <View style={[styles.item,{backgroundColor: index%2 ===0 ? 'lightgray': '#ebedeb'}]} key={item.id} >
